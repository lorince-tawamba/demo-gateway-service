...
- demo-gateway-service-1.0.0

**Create the docker image**

```bash
  docker build -t lorincetawamba/demo-gateway-service:1.0.0 -f Dockerfile .
```
...
```bash
  docker run -d -p 9000:9000 -t lorincetawamba/demo-gateway-service:1.0.0
```
...
```bash
  docker image push lorincetawamba/demo-gateway-service:1.0.0
```
